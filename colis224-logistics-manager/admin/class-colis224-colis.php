                    ...
                    <div class="colis224-form-grid">
                        ...
                        <div class="colis224-form-group">
                            ...
                            <input type="tel" name="sender_phone" id="sender_phone"
                                   placeholder="Ex: +33 6 12 34 56 78 ou +224 620 123 456"
                                   value="<?php echo $is_edit ? esc_attr($parcel->sender_phone) : ''; ?>">
                            <small>Numéro de téléphone de l'expéditeur (format international recommandé)</small>
                        </div>
                ...
                <div class="colis224-card">
                    ...
                    <table class="colis224-details-table">
                        ...
                        <tr>
                            <th>Expéditeur:</th>
                            <td>
                                <?php echo esc_html($parcel->sender_name ?: '-'); ?>
                                <?php if (!empty($parcel->sender_phone)): ?>
                                    <br><strong>📞 <?php echo esc_html($parcel->sender_phone); ?></strong>
                                <?php endif; ?>
                            </td>
                        </tr>
                        <tr>
