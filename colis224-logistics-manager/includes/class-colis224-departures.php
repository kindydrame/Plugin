...
class Colis224_Departures {
    ...
    public static function get_countries() {
        return array(
            ...
            'ML' => array('name' => 'Mali', 'flag' => '🇲🇱'),
            'BF' => array('name' => 'Burkina Faso', 'flag' => '🇧🇫'),
            'TG' => array('name' => 'Togo', 'flag' => '🇹🇬'),
            'BJ' => array('name' => 'Bénin', 'flag' => '🇧🇯'),
            'GH' => array('name' => 'Ghana', 'flag' => '🇬🇭'),
            'NG' => array('name' => 'Nigeria', 'flag' => '🇳🇬'),
            'CM' => array('name' => 'Cameroun', 'flag' => '🇨🇲'),
            'GA' => array('name' => 'Gabon', 'flag' => '🇬🇦'),
            'CG' => array('name' => 'Congo', 'flag' => '🇨🇬'),
            'CD' => array('name' => 'RD Congo', 'flag' => '🇨🇩'),
            'AE' => array('name' => 'Émirats Arabes Unis', 'flag' => '🇦🇪'),
            'SA' => array('name' => 'Arabie Saoudite', 'flag' => '🇸🇦'),
            'TR' => array('name' => 'Turquie', 'flag' => '🇹🇷'),
            'US' => array('name' => 'États-Unis', 'flag' => '🇺🇸'),
            'GB' => array('name' => 'Royaume-Uni', 'flag' => '🇬🇧'),
            'ES' => array('name' => 'Espagne', 'flag' => '🇪🇸'),
            'IT' => array('name' => 'Italie', 'flag' => '🇮🇹'),
            'DE' => array('name' => 'Allemagne', 'flag' => '🇩🇪'),
            'BE' => array('name' => 'Belgique', 'flag' => '🇧🇪'),
            'CH' => array('name' => 'Suisse', 'flag' => '🇨🇭'),
            'CA' => array('name' => 'Canada', 'flag' => '🇨🇦'),
        );
    }
