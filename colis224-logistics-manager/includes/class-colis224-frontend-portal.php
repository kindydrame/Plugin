        ...
        <div class="colis224-portal-container">
            <div class="colis224-login-box">
                ...
                <form id="colis224-client-login-form" class="colis224-login-form">
                    ...
                    <div class="colis224-form-group colis224-remember-me">
                        <label class="colis224-checkbox-label">
                            <input type="checkbox" id="remember_me" name="remember_me" value="1">
                            <span class="checkmark"></span>
                            Se souvenir de moi (30 jours)
                        </label>
                        <small>Cochez cette case pour rester connecté et récupérer votre session automatiquement</small>
                    </div>
    ...
    public function ajax_client_login() {
        ...
        try {
            ...
            if ($result['success']) {
                ...
                if ($remember_me && isset($result['client_id'])) {
                    // Créer le token "Se souvenir de moi"
                    Colis224_Client_Auth::create_remember_token($result['client_id']);
                }
                ...
                if ($remember_me) {
                    $message .= ' Votre session sera mémorisée pendant 30 jours.';
                }
